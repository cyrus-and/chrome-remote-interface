...
Chrome.Protocol = promisesWrapper(function (options, callback) {
...
Chrome.List = promisesWrapper(function (options, callback) {
...
Chrome.New = promisesWrapper(function (options, callback) {
...
Chrome.Activate = promisesWrapper(function (options, callback) {
...
Chrome.Close = promisesWrapper(function (options, callback) {
...
Chrome.Version = promisesWrapper(function (options, callback) {
...
function connectToChrome() {
    ...
    if (self.protocol === null) {
        ...
        self.protocol = self.protocol || require('./protocol.json');
        continueConnection();
    }
}
...
// httpOptions.path must be specified; callback(err, data)
